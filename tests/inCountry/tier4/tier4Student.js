module.exports = {
  'Tier 4 Student' : function (client) {
	var startPage = client.page.tier4Student();
	startPage.navigate()
		.click('@applyNow')
	...
	var hasPreviousCurtailment = client.page.hasPreviousCurtailment();
	hasPreviousCurtailment.submit();

	var currentLeaveStudentDoctorDentist = client.page.currentLeaveStudentDoctorDentist();
	currentLeaveStudentDoctorDentist.submit();
	...
	var studyAsTier4ChildStudent = client.page.studyAsTier4ChildStudent();
	studyAsTier4ChildStudent.submit();

	var degreeFromEnglishSpeakingCountry = client.page.degreeFromEnglishSpeakingCountry();
	degreeFromEnglishSpeakingCountry.submitHasDegree_Transcript();
