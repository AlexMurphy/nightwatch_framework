module.exports = {
	tags: ['EEA-CR', 'EEAQP', 'Premium', 'NoIHS'],
	'EEA(QP) with non cesc nationality and additional payment' : function (client) {
		...
		premiumServiceAppointmentBookingApplicationType.submitEEAQP()
