module.exports = {
	tags: ['SET', 'NonCESC', 'Child', 'NoIHS'],
  'SET-O with non-cesc main applicant and child' : function (client) {
		...
		premiumServiceAppointmentBookingApplicationType.submitSETO()

		var premiumServiceAppointmentBookingLeaveCategorySetO = client.page.premiumServiceAppointmentBookingLeaveCategorySetO();
		premiumServiceAppointmentBookingLeaveCategorySetO.submit()
		...
		var birthDetails = client.page.birthDetails();
		birthDetails.submitNonCescChild();
	...
	client.click('.button');
		...
		paymentConfirmation.assertSETWithChild();
