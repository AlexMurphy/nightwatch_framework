module.exports = {
	tags: ['Transfer', 'NTL', 'NoIHS'],
  'NTL with non cesc nationality' : function (client) {
		...
		premiumServiceAppointmentBookingApplicationType.submitNTL()
