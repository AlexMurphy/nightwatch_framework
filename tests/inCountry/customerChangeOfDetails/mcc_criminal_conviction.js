module.exports = {
  'MCC Criminal Convictions' : function (client) {
	...
	detailsToChange.submitCriminalConvictions();

	var criminalConvictionType = client.page.criminalConvictionType();
	criminalConvictionType.submitCriminalConviction();

	var generalConviction = client.page.generalConviction();
	generalConviction.submit();

	var criminalConvictions = client.page.criminalConvictions();
	criminalConvictions.submitNoOtherCriminalConvictions();
